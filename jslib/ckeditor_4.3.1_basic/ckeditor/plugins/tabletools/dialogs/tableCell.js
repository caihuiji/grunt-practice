CKEDITOR.dialog.add("cellProperties", function(a) {
    var b = a.lang.table, c = b.cell, d = a.lang.common, e = CKEDITOR.dialog.validate, f = /^(\d+(?:\.\d+)?)(px|%)$/, g = {
        type: "html",
        html: "&nbsp;"
    }, h = "rtl" == a.lang.dir, i = a.plugins.colordialog;
    return {
        title: c.title,
                ...
                children: [ {
                    ...
                    children: [ {
                        ...
                        children: [ {
                            ...
                            setup: function(a) {
                                ...
                                !isNaN(b) && this.setValue(b), !isNaN(a) && this.setValue(a);
                            },
                            commit: function(a) {
                            ...
                            setup: function(a) {
                                (a = f.exec(a.getStyle("width") || a.getAttribute("width"))) && this.setValue(a[2]);
                            }
                        } ]
                    }, {
                        type: "hbox",
                        ...
                        commit: function(a) {
                            var b = this.getValue();
                            b ? a.setStyle("text-align", b) : a.removeStyle("text-align"), a.removeAttribute("align");
                        }
                    }, {
                        type: "select",
                        id: "vAlign",
                        ...
                        commit: function(a) {
                            var b = this.getValue();
                            b ? a.setStyle("vertical-align", b) : a.removeStyle("vertical-align"), a.removeAttribute("vAlign");
                        }
                    } ]
                }, g, {
                    type: "vbox",
                    ...
                    children: [ {
                        ...
                        children: [ {
                            ...
                            onClick: function() {
                                a.getColorFromDialog(function(a) {
                        ...
                        children: [ {
                            ...
                            "class": "colorChooser",
                            label: c.chooseColor,
                            style: (h ? "margin-right" : "margin-left") + ": 10px",
                            onLoad: function() {
                                this.getElement().getParent().setStyle("vertical-align", "bottom");
                            },
                            onClick: function() {
