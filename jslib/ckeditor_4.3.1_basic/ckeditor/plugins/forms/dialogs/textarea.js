CKEDITOR.dialog.add("textarea", function(a) {
    return {
        title: a.lang.forms.textarea.title,
        minWidth: 350,
        minHeight: 220,
        onShow: function() {
        ...
        onOk: function() {
            ...
            c && (a = this.getParentEditor(), b = a.document.createElement("textarea")), this.commitContent(b), 
            c && a.insertElement(b);
        },
        contents: [ {
            id: "info",
            label: a.lang.forms.textarea.title,
            title: a.lang.forms.textarea.title,
            elements: [ {
                id: "_cke_saved_name",
                type: "text",
                ...
                children: [ {
                    id: "cols",
                    type: "text",
                    label: a.lang.forms.textarea.cols,
                    "default": "",
                    accessKey: "C",
                    style: "width:50px",
                    ...
                    id: "rows",
                    type: "text",
                    label: a.lang.forms.textarea.rows,
                    "default": "",
                    accessKey: "R",
                    style: "width:50px",
                    validate: CKEDITOR.dialog.validate.integer(a.lang.common.validateNumberFailed),
